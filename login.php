...
<head>
    ...
    <title>Login - HappyTail Grooming</title>
    ...
    <div class="login-container">
        <div class="login-box">
            <div class="logo-section">
                ...
                <p>Cat Grooming Appointment System</p>
            </div>
            <form action="loginSession.php" method="POST" class="login-form">
                <?php if ($error): ?>
                ...
                <div style="text-align: center; margin-top: 20px;">
                    <p style="color: var(--text-secondary);">Don't have an account? <a href="register.php" style="color: var(--primary-color); text-decoration: none;">Sign Up here</a></p>
                </div>
            </form>
        </div>
        <div style="text-align: center; margin-top: 20px;">
